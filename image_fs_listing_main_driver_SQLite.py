...
gTargetDriveStr = 'C:\\palashworld\\_dev\\HOME_PY\\als_Foto\\images\\New folder'
db_loc_1 = 'image_fs_listing_DB.sqlite'
...
def countDriveFiles ( pDrivePathStr):  
    ...
    for root, dirs, files in os.walk(pDrivePathStr):
        ...
        for file in files:
            ...
            file_deatils_obj.width = exifData.get("ImageWidth")
